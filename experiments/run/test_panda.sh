...
#for CSTrack test
cd ../tracking
mpirun -np 1 python test_cstrack_panda_mpi.py 
--test_panda True --det_results ../yolov5_panda --nms_thres 0.5 --conf_thres 0.5 --weights ../weights/cstrack_panda.pt  --vis_state 1 
